...
import com.example.chatkma.AES.Aes;
...
//        actionBar.hide();
    ...
    private void sendMessage(String message) {
        ...
        hashMap.put("message",""+aes.encrypt(message,user.getUid()));
...
//                            String p_downloadUri = p_uriTask.getResult().toString();
                            if (p_uriTask.isSuccessful()){
                                ...
                                HashMap<String,Object> hashMap= new HashMap<>();
                                hashMap.put("sender",""+firebaseAuth.getUid());
                                hashMap.put("message",""+aes.encrypt(p_downloadUri.toString(),user.getUid()));
                                hashMap.put("timestamp",""+timestamp);
